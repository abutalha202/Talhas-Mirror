...
async def progress_bar(current, total):
    ...
    upload_speed = 20 * 1024 * 1024  # Initial upload speed estimate (20 MB/s)
...
async def upload_file(file_path, real_name):
    ...
    try:
        if f_type == "video":
            ...
            await MSG.sent_msg.reply_video(
                video=file_path,
            ...
            await MSG.sent_msg.reply_audio(
                audio=file_path,
                caption=caption,
                thumb=thmb_path,
                progress=progress_bar,
            ...
            await MSG.sent_msg.reply_document(
                document=file_path,
                caption=caption,
                thumb=thmb_path,
                progress=progress_bar,
            ...
            await MSG.sent_msg.reply_photo(
                photo=file_path,
                caption=caption,
                progress=progress_bar,
                reply_to_message_id=MSG.sent_msg.id,
